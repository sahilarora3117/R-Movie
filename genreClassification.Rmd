---
title: "Movie analysis and score prediction"
...
According to this plot most movies have around 100 critic reviews   
...
This plot tells us the variation of the IMDB scores over the years. The main point to be noted here is that there is a decrease in the average rating with increase in years
...
This is a plot of mean IMDB score of each country. Even though USA produced the highest number of movies, Libya has the highest average score.
...
For the rest of the models we have categorized the movies into three different categories (Low, Medium and High)
